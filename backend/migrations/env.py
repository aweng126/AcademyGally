...
# Override sqlalchemy.url from environment so migrations use the same DB
database_url = os.getenv("DATABASE_URL", "sqlite:///./data/academy.db")
config.set_main_option("sqlalchemy.url", database_url)

# Import all models so autogenerate can detect schema
from database import Base  # noqa: E402
import models.paper  # noqa: F401, E402
